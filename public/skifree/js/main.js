...
var global = this;
var infoBoxControls = 'Используйте WASD или мышку для управления персонажем';
if (isMobileDevice()) infoBoxControls = 'Нажмите или удерживайте для управления персонажем';
...
function startNeverEndingGame (images) {
	...
	function detectEnd () {
		if (!game.isPaused()) {
			...
			infoBox.setLines([
				'Игра окончена!',
				'Нажмите пробела для начала новой игры'
			]);
			game.pause();
			game.cycle();
		}
	...
	game.beforeCycle(function () {
		...
		if (!game.isPaused()) {
			...
			infoBox.setLines([
				infoBoxControls,
				'Проехано ' + distanceTravelledInMetres + 'm',
				'Лыжников позади: ' + livesLeft,
				'Лучший счет:  ' + highScore,
				'Текущая скорость: ' + player.getSpeed()/*,
